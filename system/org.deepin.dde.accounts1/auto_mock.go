...
func (v *MockInterfaceAccounts) GoSetTerminalLocked(flags dbus.Flags, ch chan *dbus.Call, locked bool) *dbus.Call {
...
func (v *MockInterfaceAccounts) SetTerminalLocked(flags dbus.Flags, locked bool) error {
...
func (v *MockInterfaceAccounts) IsTerminalLocked() proxy.PropBool {
	mockArgs := v.Called()
